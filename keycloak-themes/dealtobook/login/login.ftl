...
<#--                    <span>${msg("noAccount")} </span>-->
                ...
                margin-top: 5px;
                    ...
                    <div style="display: flex;margin-bottom: 10px;">
                        <a class="pf-c-button pf-m-control pf-m-block register-button" type="button" href="http://localhost:4200/register/client">
                            <i class="client-register-icon"></i>
                            <span class="register-button-title ">${msg("doRegisterClient")}</span>
                        </a>
                        <a class="pf-c-button pf-m-control pf-m-block register-button" type="button" href="http://localhost:4200/register/provider">
                            <i class="provider-register-icon"></i>
                            <span class="register-button-title ">${msg("doRegisterProvider")}</span>
                        </a>
                        <a class="pf-c-button pf-m-control pf-m-block register-button" type="button" href="http://localhost:4200/register/agency">
